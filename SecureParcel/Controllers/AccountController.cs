...
namespace SecureParcel.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /Account/Entry
        [AllowAnonymous]
        public ActionResult Entry(string returnUrl)
        {
        ...
        public async Task<ActionResult> Entry(EntryViewModel model, string returnUrl)
        {
            ...
            {
                var user = await dbContext.Users.FirstOrDefaultAsync(x => x.PublicKey == model.PublicKey);

                var result = await SignInManager.PasswordSignInAsync(model.PublicKey, model.PrivateKey, true, shouldLockout: false);
